...
def plot_depth(*args):
  '''Plot depth traces generated by `samtools depth` for one or more alignments'''
  depths = kindel.parse_samtools_depth(*args)
  kindel.plot_samtools_depth(depths)


def main():
    parser = argh.ArghParser()
    parser.add_commands([consensus, weights, variants, plot_depth])
    parser.dispatch()
