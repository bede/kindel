...
def reconcile_gaps(gaps, weights, clip_weights, min_depth):
    ...
    for gap in gaps:
        ...
        gap_consensuses.append(r_overhang[:index].lower() if index >= 0 else None)
...
def bam_to_consensus_seqrecord(bam_path,
    ...
    if fix_gaps:
        ...
        gap_consensuses = reconcile_gaps(gaps, weights, clip_weights, min_depth)
